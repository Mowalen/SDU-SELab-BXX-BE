...
pool1 = redis.ConnectionPool(
    host="127.0.0.1", port=6379, db=1, encoding="UTF-8", password=redis_password
)
pool2 = redis.ConnectionPool(
    host="127.0.0.1", port=6379, db=2, encoding="UTF-8", password=redis_password
)
pool3 = redis.ConnectionPool(
    host="127.0.0.1", port=6379, db=3, encoding="UTF-8", password=redis_password
)
pool4 = redis.ConnectionPool(
    host="127.0.0.1", port=6379, db=4, encoding="UTF-8", password=redis_password
)
pool5 = redis.ConnectionPool(
    host="127.0.0.1", port=6379, db=5, encoding="UTF-8", password=redis_password
)
